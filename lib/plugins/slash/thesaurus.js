...
var getWords = function(stuart, word, url, user, callback) {
...
module.exports.run = function(request, args, stuart, plugin) {
	...
	if (args.length === 1) {
		...
		getWords(stuart, word, url, request.user_name, function(result) {
...
module.exports.help = function(request, stuart) {
	stuart.slack_post("Find synonyms and antonyms of a given word.\n\n Usage: */stuart thesaurus [word]*", '@'+request.user_name, request.user_name);
}